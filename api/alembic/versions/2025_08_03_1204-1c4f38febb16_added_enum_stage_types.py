...
def upgrade() -> None:
    ...
    stagetypes_enum = postgresql.ENUM('NEW', 'HR', 'TECH', 'BUSINESS', 'REJECTED', 'OFFER', name='stagetypes')
    ...
    op.execute("ALTER TABLE stage ALTER COLUMN stage_type TYPE stagetypes USING stage_type::stagetypes")
...
def downgrade() -> None:
    ...
    op.alter_column('stage', 'stage_type',
               existing_type=postgresql.ENUM('NEW', 'HR', 'TECH', 'BUSINESS', 'REJECTED', 'OFFER', name='stagetypes'),
